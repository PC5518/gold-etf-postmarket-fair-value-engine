...
def add_branding_header(fig):
    ...
    fig.text(0.5, 0.96, "TATA GOLD ETF AFTER MARKET HOURS RUNNING PRICE", 
...
def get_etf_data_selenium(symbol="TATAGOLD"):
...
def run_terminal(gold_symbol="XAUUSD"):
    ...
    # 1. Get NSE Data
    inav_str, close_str, raw_date_str = get_etf_data_selenium("TATAGOLD")
